...
public class Videojuego implements Entregable{
   ...
   public boolean equals(Videojuego a){
       if (titulo.equalsIgnoreCase(a.getTitulo()) && companyia.equalsIgnoreCase(a.getcompanyia())){
           return true;
       }
       return false;
   }
...
/**
    ...
    */
   public Videojuego(String titulo, String companyia){
       this(titulo,HORAS_ESTIMADAS_DEF, "", companyia);
       }
